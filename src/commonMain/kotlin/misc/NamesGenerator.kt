// random name generator Docker style, from docker. see https://github.com/moby/moby/blob/master/pkg/namesgenerator/names-generator.go
...
fun GetRandomName(retry: Int): String {
    var name = ""
    do {
        name = "${left[Random.nextInt(left.size)]}_${right[Random.nextInt(right.size)]}"
